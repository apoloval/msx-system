...
M0D0C   EQU     0D0CH                   ; BIOS routine pop af,bc,de,hl ret
M0D0D   EQU     0D0DH                   ; BIOS routine pop bc,de,hl ret
M0DE3   EQU     0DE3H                   ;
...
DF30F   EQU     0F30FH                  ; double byte character headers

MASTER  EQU     0F348H                  ; slotid disksystem master ROM
DF349   EQU     0F349H                  ; disksystem bottom (lowest address used by the disksystem)
DF36B   EQU     0F36BH                  ; enable DOS RAM on page 1
WRPRIM  EQU     0F385H
LINL40  EQU     0F3AEH
LINL32  EQU     0F3AFH
LINLEN  EQU     0F3B0H
...
J43A3:  LD      A,(H.PHYD+0)
        ...
        LD      (DF30F+0),HL
        LD      HL,0FDE0H
        LD      (DF30F+2),HL            ; double byte character headers
J43B6:  CALL    C442D                   ; calculate and set kanji screenwidth
        CALL    C422A                   ; nothing (was hook H.TIMI)
        POP     AF
        POP     HL
        JR      NZ,C4418                ; KANJI already enabled,
...
J452C:  SUB     0EH     ; 14
        ...
        ADD     A,E
        LD      (CLMLST),A
        CALL    C4583                  ; replace return address with RET
        RET
...
;         Subroutine replace return address with RET
;            Inputs  ________________________
;            Outputs ________________________
...
;            Inputs  ________________________
;            Outputs ________________________
;            Remark  Not used, orginal KANJI H.TIMI handler
...
J6858:  PUSH    AF
        ...
        CP      0C9H                    ; disk environment ?
        JR      Z,J6886
        LD      (DF349),HL             ; yep, adjust disksystem bottom (lowest address used by the disksystem)
