...
CF1E5   EQU     0F1E5H                  ; KEYINT handler
CF1E8   EQU     0F1E8H                  ; RDSLT handler
CF1EB   EQU     0F1EBH                  ; WRSLT handler
CF1EE   EQU     0F1EEH                  ; CALSLT handler
CF1F1   EQU     0F1F1H                  ; ENASLT handler
CF1F4   EQU     0F1F4H                  ; CALLF handler
CF1F7   EQU     0F1F7H                  ; enable BDOS segments
CF1FA   EQU     0F1FAH                  ; enable DOS segments
CF206   EQU     0F206H                  ; RD_SEG
CF209   EQU     0F209H                  ; WR_SEG
CF224   EQU     0F224H                  ; PUT_P2
DF23C   EQU     0F23CH                  ; default drive
DF23D   EQU     0F23DH                  ; default transfer address
C$F252  EQU     0F252H  ; -C---
C$F255  EQU     0F255H  ; -C---
C$F258  EQU     0F258H  ; -C---
C$F25B  EQU     0F25BH  ; -C---
