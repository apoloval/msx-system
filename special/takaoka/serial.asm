; Serial interface Takaoka

; Source re-created by Z80DIS 2.2
; Z80DIS was written by Kenneth Gielow, Palo Alto, CA

; Code Copyrighted by Microsoft,ASCII and maybe others
...
I4075:	CALL	C.4E7E			; disable RS232 interrupts
        LD	IY,I.4143
        CALL	C.4D0B
        CALL	C.4131
        DI	
...
C.4260:	OR	A
        ...
        SET	3,(HL)
        DI	
        CALL	C.4E85			; enable RS232 interrupts
        CALL	C.5189
I$4295:	EI	
        OR	A
        POP	HL
...
J$42AB:	DI	
        CALL	C.51E4
        CALL	C.5191
        CALL	C.4E7E			; disable RS232 interrupts
        EI	
        LD	HL,D.FB1B
        RES	3,(HL)
        POP	HL
...
J.4645:	EI	
        ...
        JP	C,J.44A3
        CALL	C.4C50
        CALL	NZ,C.4E85			; enable RS232 interrupts
        LD	A,(D.F560)
        BIT	5,A
        CALL	NZ,C.5189
        AND	A
...
J$4DA6:	LD	A,C
        ...
        JP	C,J.4D2C
        LD	C,0			; channel 0
        CALL	C.5248			; set baudrate channel
        LD	E,(IY+10)
        LD	D,(IY+11)
        CALL	C.4DF4
        JP	C,J.4D2C
...
C$4EF2:	LD	A,(D.FB1B)
        ...
        AND	(HL)
        LD	C,A
        CALL	C.5175			; read status i8251 and clear error bits
        LD	B,A
        AND	A
        JR	NZ,J$4F25
        LD	HL,D.FB1B
...
C$509E:	LD	A,(D.FB1C)
        ...
        LD	D,A
J$50A9:	LD	E,64H	; "d"
J$50AB:	CALL	C.5237			; setup channel 2 i8253 for 10 ms
J.50AE:	EI	
        CALL	C.44DF
        DI	
        RET	C
        ...
        AND	A
        JR	Z,J.50AE
        CALL	C.5243			; channel 2 i8253 finished ?
        JR	NC,J.50AE
        AND	A
        DEC	E
        JR	NZ,J$50AB
...
J$512D:	IN	A,(0E7H)
        ...
        CALL	C.5175			; read status i8251 and clear error bits
        LD	A,07H	; 7 
        CALL	C.5224			; write i8251 command (with error clear)
        IN	A,(80H)
        JP	C.5175			; read status i8251 and clear error bits
...
J$519C:	LD	A,(D.FB1E)
        RES	5,A
J$51A1:	CALL	C.5224			; write i8251 command (with error clear)
        POP	AF
        RET	
...
J$51B2:	DI	
        ...
        LD	A,(D.FB1E)
        AND	0FDH
J$51B9:	CALL	C.5224			; write i8251 command (with error clear)
        POP	AF
        RET	
...
C.51F3:	LD	A,(D.FB1C)
        ...
        LD	D,A
J$51FE:	LD	E,64H	; "d"
J$5200:	CALL	C.5237			; setup channel 2 i8253 for 10 ms
J.5203:	CALL	C.44DF
        EI	
        RET	C
        IN	A,(82H)
