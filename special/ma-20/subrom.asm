...
J06CA:	PUSH	AF
        ...
        OUT	(89H),A
        LD	A,080H+17
        OUT	(89H),A			; set indirect vdp register pointer to 0, autoincrement
...
J0F7E:	PUSH	HL
        ...
        LD	B,16			; 16 colors
J0F8F:	IN	A,(88H)			; read VRAM
        NOP				; wait
        OUT	(8AH),A			; write pallette register
        NOP				; wait
        IN	A,(88H)			; read VRAM
        NOP				; wait
        OUT	(8AH),A			; write pallette register
...
J1172:	CALL	C29EB			; write colorregister
        ...
        OUT	(89H),A
        LD	A,080H+17
        OUT	(89H),A			; set indirect vdp register pointer to 44, non-autoincrement
        LD	A,C
        LD	C,8BH
        DI
        JR	J11A3
...
C15DB:	LD	A,36
        ...
        OUT	(89H),A
        LD	A,080H+17
        OUT	(89H),A			; set indirect vdp register pointer to 36, autoincrement
        LD	A,L
        OUT	(8BH),A
        LD	A,H
        OUT	(8BH),A
...
J1B8A:	PUSH	HL
        ...
        XOR	A
        OUT	(89H),A
        OUT	(89H),A			; VRAM address pointer=0
        OUT	(89H),A
        LD	A,080H+14
        OUT	(89H),A			; vdp register 14=0
        CALL	C1CF3			; select RP-501 bank 3
        CALL	C1CD0			; read RP-501 register 0
        JR	Z,J1C35
        DEC	A
...
J28E6:	PUSH	BC
        ...
        OUT	(89H),A
        LD	A,080H+15
        OUT	(89H),A			; select vdp statusregister 8
        IN	A,(89H)
        LD	L,A
        LD	A,9
        OUT	(89H),A
        LD	A,080H+15
        OUT	(89H),A			; select vdp statusregister 9
        IN	A,(89H)
        PUSH	AF
        XOR	A
        OUT	(89H),A
        LD	A,080H+15
        OUT	(89H),A			; select vdp statusregister 0
        EI
        POP	AF
        AND	01H	; 1
        LD	H,A
...
C2925:	PUSH	AF
        ...
        OUT	(89H),A
        LD	A,080H+17
        OUT	(89H),A			; set indirect vdp register pointer to 32, autoincrement
        LD	A,L
        OUT	(8BH),A			; SX low
        LD	A,H
        OUT	(8BH),A			; SX high
...
C2961:	CALL	C29A5			; write DX,DY registers
        ...
        OUT	(89H),A
        LD	A,080H+17
        OUT	(89H),A			; set indirect vdp register pointer to 44, autoincrement
        LD	A,(ATRBYT)
        OUT	(8BH),A
        XOR	A
        OUT	(8BH),A
...
C298B:	DI
        OUT	(89H),A
        LD	A,080H+15
        OUT	(89H),A			; select vdp statusregister
        PUSH	HL
        POP	HL
        IN	A,(89H)			; read vdp statusregister
        PUSH	AF
        XOR	A
        OUT	(89H),A
        LD	A,080H+15
...
J29A8:	PUSH	AF
        ...
        OUT	(89H),A
        LD	A,080H+17
        OUT	(89H),A			; set indirect vdp register pointer
        LD	A,L
        OUT	(8BH),A
        LD	A,H
        OUT	(8BH),A
...
C29C4:	LD	A,40
        ...
        OUT	(89H),A
        LD	A,080H+17
        OUT	(89H),A			; set indirect vdp register pointer to 40, autoincrement
        LD	A,E
        OUT	(8BH),A
        LD	A,D
        OUT	(8BH),A
...
J31EF:	CALL	C3292
        ...
        OUT	(89H),A
        LD	A,080H+15
        OUT	(89H),A			; select vdp statusregister 7
        PUSH	HL
        POP	HL
        LD	A,D
        RRCA
