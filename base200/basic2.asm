...
; MSX BASIC ROM, MSX 2 version (version 2.0)
...
PTCPA1: DEC     HL
        ...
        OR      L
        JR      NZ,PTCPA1               ; wait
        JP      M.0431                  ; resume orginal routine
...
;       Subroutine      patchroutine for PAL setup of VDP (part 1)
;       Inputs          ________________________
;       Outputs         ________________________
...
J7D87:	CALL	C7E1A
        ...
        PUSH	AF
        POP	IY
        CALL	NZ,C7FF5		; if extension ROM has INIT, call INIT after VR
        POP	BC
        POP	HL
