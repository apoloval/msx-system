...
;       Table   keycodes for scancode $00-$2F Graph layout
        ...
        DEFB    $09,$AC,$AB,$BA,$EF,$BD,$F4,$FB
        DEFB    $EC,$07,$17,$F1,$1E,$01,$0D,$06
        DEFB    $05,$BB,$F3,$F2,$1D,$FF,$C4,$11
        DEFB    $BC,$C7,$CD,$14,$15,$13,$DC,$C6
        DEFB    $DD,$C8,$0B,$1B,$C2,$DB,$CC,$18
        DEFB    $D2,$12,$C0,$1A,$CF,$1C,$19,$0F

;       Table   keycodes for scancode $00-$2F Shift+Graph layout


        DEFB    $0A,$00,$FD,$FC,$00,$00,$F5,$00
        DEFB    $00,$08,$1F,$F0,$16,$02,$0E,$04
        DEFB    $03,$F7,$AE,$AF,$F6,$FF,$FE,$00
        DEFB    $FA,$C1,$CE,$D4,$10,$D6,$DF,$CA
        DEFB    $DE,$C9,$0C,$D3,$C3,$D7,$CB,$A9
        DEFB    $D1,$00,$C5,$D5,$D0,$F9,$AA,$F8


;       Table   keycodes for scancode $00-$2F Code layout

        DEFB    $EB,$9F,$D9,$BF,$9B,$98,$E0,$E1
        DEFB    $E7,$87,$EE,$E9,$00,$ED,$DA,$B7
...
;       Table   keycodes for scancode $00-$2F Shift+Code layout
        ...
        DEFB    $D8,$AD,$9E,$BE,$9C,$9D,$00,$00
        DEFB    $E2,$80,$00,$00,$00,$E8,$EA,$B6
        DEFB    $B8,$E4,$8F,$00,$A8,$FF,$8E,$00
        DEFB    $00,$00,$00,$99,$9A,$B0,$00,$92
        DEFB    $B2,$B4,$00,$A5,$00,$E3,$00,$00
...
;       Table   translation DEAD
        ...
        DEFB    $85,$8A,$8D,$95,$97,'y'

;       Table   translation DEAD+SHIFT

        DEFB    $A0,$82,$A1,$A2,$A3,'y'

;       Table   translation DEAD+CODE

        DEFB    $83,$88,$8C,$93,$96,'y'
...
D107F:  DEFB    $83,$88,$8C,$93,$96,$84,$89,$8B
        DEFB    $94,$81,$98,$A0,$82,$A1,$A2,$A3
        DEFB    $85,$8A,$8D,$95,$97,$B1,$B3,$B5
        DEFB    $B7,$A4,$86,$87,$91,$B9,'y'

;       Table   translation accent characters with upcase

D109E:  DEFB    'A' ,'E' ,'I' ,'O' ,'U' ,$8E ,'E' ,'I'
        DEFB    $99 ,$9A ,'Y' ,'A' ,$90 ,'I' ,'O' ,'U'
        DEFB    'A' ,'E' ,'I' ,'O' ,'U' ,$B0 ,$B2 ,$B4
        DEFB    $B6 ,$A5 ,$8F ,$80 ,$92 ,$B8 ,'Y'
