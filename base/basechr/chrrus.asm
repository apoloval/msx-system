        ...
        DEFB	088H,050H,020H,0F8H,020H,050H,088H,000H
        ...
        DEFB	088H,070H,088H,088H,070H,088H,000H,000H
        DEFB	000H,000H,090H,0A8H,0E8H,0A8H,090H,000H
        DEFB	000H,000H,060H,010H,070H,090H,068H,000H
        DEFB	000H,000H,0F0H,080H,0F0H,088H,0F0H,000H
        DEFB	000H,000H,090H,090H,090H,0F8H,008H,000H
        DEFB	000H,000H,030H,050H,050H,070H,088H,000H
        DEFB	000H,000H,070H,088H,0F8H,080H,070H,000H
        DEFB	000H,020H,070H,0A8H,0A8H,070H,020H,000H
        DEFB	000H,000H,078H,048H,040H,040H,040H,000H
        DEFB	000H,000H,088H,050H,020H,050H,088H,000H
        DEFB	000H,000H,088H,098H,0A8H,0C8H,088H,000H
        DEFB	000H,050H,020H,000H,098H,0A8H,0C8H,000H
        DEFB	000H,000H,090H,0A0H,0C0H,0A0H,090H,000H
        DEFB	000H,000H,038H,028H,028H,048H,088H,000H
        DEFB	000H,000H,088H,0D8H,0A8H,088H,088H,000H
        DEFB	000H,000H,088H,088H,0F8H,088H,088H,000H
        DEFB	000H,000H,070H,088H,088H,088H,070H,000H
        DEFB	000H,000H,078H,048H,048H,048H,048H,000H
        DEFB	000H,000H,078H,088H,078H,028H,048H,000H
        DEFB	000H,000H,0F0H,088H,0F0H,080H,080H,000H
        DEFB	000H,000H,078H,080H,080H,080H,078H,000H
        DEFB	000H,000H,0F8H,020H,020H,020H,020H,000H
        DEFB	000H,000H,088H,050H,020H,040H,080H,000H
        DEFB	000H,000H,0A8H,070H,020H,070H,0A8H,000H
        DEFB	000H,000H,0F0H,048H,070H,048H,0F0H,000H
        DEFB	000H,000H,040H,040H,070H,048H,070H,000H
        DEFB	000H,000H,088H,088H,0C8H,0A8H,0C8H,000H
        DEFB	000H,000H,0F0H,008H,070H,008H,0F0H,000H
        DEFB	000H,000H,0A8H,0A8H,0A8H,0A8H,0F8H,000H
        DEFB	000H,000H,070H,088H,038H,088H,070H,000H
        DEFB	000H,000H,0A8H,0A8H,0A8H,0F8H,008H,000H
        DEFB	000H,000H,048H,048H,078H,008H,008H,000H
        DEFB	000H,000H,0C0H,040H,070H,048H,070H,000H
        DEFB	090H,0A8H,0A8H,0E8H,0A8H,0A8H,090H,000H
        DEFB	020H,050H,088H,088H,0F8H,088H,088H,000H
        DEFB	0F8H,088H,080H,0F0H,088H,088H,0F0H,000H
        DEFB	090H,090H,090H,090H,090H,0F8H,008H,000H
        DEFB	038H,028H,028H,048H,048H,0F8H,088H,000H
        DEFB	0F8H,080H,080H,0F0H,080H,080H,0F8H,000H
        DEFB	020H,070H,0A8H,0A8H,0A8H,070H,020H,000H
        DEFB	0F8H,088H,088H,080H,080H,080H,080H,000H
        DEFB	088H,088H,050H,020H,050H,088H,088H,000H
        DEFB	088H,088H,098H,0A8H,0C8H,088H,088H,000H
        DEFB	050H,020H,088H,098H,0A8H,0C8H,088H,000H
        DEFB	088H,090H,0A0H,0C0H,0A0H,090H,088H,000H
        DEFB	018H,028H,048H,048H,048H,048H,088H,000H
        DEFB	088H,0D8H,0A8H,0A8H,088H,088H,088H,000H
        DEFB	088H,088H,088H,0F8H,088H,088H,088H,000H
        DEFB	070H,088H,088H,088H,088H,088H,070H,000H
        DEFB	0F8H,088H,088H,088H,088H,088H,088H,000H
        DEFB	078H,088H,088H,078H,028H,048H,088H,000H
        DEFB	0F0H,088H,088H,0F0H,080H,080H,080H,000H
        DEFB	070H,088H,080H,080H,080H,088H,070H,000H
        DEFB	0F8H,020H,020H,020H,020H,020H,020H,000H
        DEFB	088H,088H,088H,050H,020H,040H,080H,000H
        DEFB	0A8H,0A8H,070H,020H,070H,0A8H,0A8H,000H
        DEFB	0F0H,048H,048H,070H,048H,048H,0F0H,000H
        DEFB	080H,080H,080H,0F0H,088H,088H,0F0H,000H
        DEFB	088H,088H,088H,0C8H,0A8H,0A8H,0C8H,000H
        DEFB	0F0H,008H,008H,030H,008H,008H,0F0H,000H
        DEFB	0A8H,0A8H,0A8H,0A8H,0A8H,0A8H,0F8H,000H
        DEFB	070H,088H,008H,078H,008H,088H,070H,000H
        DEFB	0A8H,0A8H,0A8H,0A8H,0A8H,0F8H,008H,000H
        DEFB	088H,088H,088H,088H,078H,008H,008H,000H
        DEFB	000H,000H,000H,000H,000H,000H,000H,000H
